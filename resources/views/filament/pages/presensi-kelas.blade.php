            ...
            <div class="ml-3 flex-1">
                ...
                <ul class="text-sm text-red-700 space-y-1">
                    <li class="flex items-start">
                        <span class="w-2 h-2 bg-red-400 rounded-full mt-2 mr-3 shrink-0"></span>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <ul class="text-md text-green-700 space-y-1">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-green-400 rounded-full mt-2 mr-3 shrink-0"></span>
                            <span> ✅  Hari sekolah aktif - Presensi dapat dilakukan</span>
                        </li>
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-green-400 rounded-full mt-2 mr-3 shrink-0 text-md"></span>
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 flex-1">
                    ...
                    <ul class="text-sm text-yellow-700 space-y-1">
                        <li class="flex items-start">
                            <span class="w-2 h-2 bg-yellow-400 rounded-full mt-2 mr-3 shrink-0"></span>
